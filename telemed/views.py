...
def dashboard(request):
	...
	context = { 'doctors': doctors, 'patients': patients, 'available_doctors':available_doctors, 'patient_requests':patient_requests, 'assigned_doctor':assigned_doctor }
...
def show_patient_info(request, pk):
	...
	if user_group == 'Physician':
		...
		if request.method == 'POST' and 'add-record' in request.POST:
			new_record = ConsultationRecord(patientID=patient_id, physicianID=curr_physician_id)
	...
	context = {'patient':patient, 'assigned_doctor':assigned_doctor, 'consultation_record':consultation_record}
...
def edit_consultation_record(request, pk):
	...
	if request.method == "POST" and "editrecord" in request.POST:
